...
struct SToolBarDataEx {
  const char *pixmap_name;            // normal picture
  const char **pixmap_data;
  const char *pixmap_on_name;         // mouse-on picture
  const char **pixmap_on_data;
  const char *pixmap_disabled_name;   // disabled picture
  const char **pixmap_disabled_data;
  const char *label;
  const char *tip_text;
  int  type;
  int  id;
