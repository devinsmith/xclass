...
OHtmlElement *OXHtml::GetMap(const char *name) {
...
int OXHtml::GetColorByName(const char *zColor) {
  XColor *pNew;
  int iColor;
...
const char *OXHtml::GetHref(int x, int y, const char **target) {
  OHtmlBlock *pBlock;
  OHtmlElement *pElem;
  char *z;
...
OHtmlElement *OXHtml::AttrElem(const char *name, char *value) {
  OHtmlElement *p;
  const char *z;
