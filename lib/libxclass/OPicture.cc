...
const OPicture *OPicturePool::GetPicture(const char *name, const char **data)
{
  OPicKey key;
  OHashEntry *h;
  OPicture *pic;
...
int OPicturePool::LocatePicture(const char *name, const char *path, char *bfr)
{
