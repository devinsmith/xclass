...
int OResourcePool::SetDefaults(Sconfig *conf) {
  ...
  const char *hm10 = "-adobe-helvetica-medium-r-*-*-10-*-*-*-*-*-iso8859-1";
  const char *hm12 = "-adobe-helvetica-medium-r-*-*-12-*-*-*-*-*-iso8859-1";
  const char *hb12 = "-adobe-helvetica-bold-r-*-*-12-*-*-*-*-*-iso8859-1";
  const char *cm12 = "-adobe-courier-medium-r-*-*-12-*-*-*-*-*-iso8859-1";
